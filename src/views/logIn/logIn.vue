  ...
  <div class="main">
    <div class="box">
      <a-tabs v-model:activeKey="activeKey" style="width: 40%;height: 100%;background: white">
        <a-tab-pane key="1" tab="登录"><a-form style="width: 100%;background: white;height: 100%;" :model="formState"
            name="basic" autocomplete="off" @finish="onFinish" @finishFailed="onFinishFailed">
